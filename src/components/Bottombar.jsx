...
function Bottombar() {
 ...
 function handleclick(sec){
  ...
  return (
    <div className='flex fixed bottom-0 md:bottom-auto md:top-20  h-16 flex-row md:flex-col w-full 2xl:w-[5%] xl:w-[6%] lg:w-[8%] md:w-[9%] md:h-full md:pb-24 justify-evenly  items-center primary-bg-dark   overflow-y-hidden'>
